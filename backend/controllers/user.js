...
exports.getProfile = async(req, res) => {
  ...
  user._doc.isFriendRequestSent = user.friendRequests.some(r => req.user._id.equals(r.user))
  user._doc.didUserSendFriendRequest = req.user.friendRequests.some(r => user._id.equals(r.user))
